            ...
            <FadeIn delay={300}>
              <div className="flex items-center justify-center md:justify-start gap-4 flex-wrap">
                ...
                <a
                  ...
                  aria-label="LinkedIn"
                  className="inline-flex items-center justify-center w-10 h-10 rounded-full text-vercel-black dark:text-white shadow-vercel-border dark:shadow-dark-border transition-all hover:text-vercel-gray-600 dark:hover:text-vercel-gray-400 hover:shadow-vercel-card dark:hover:shadow-dark-card"
                >
