      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-8">
        ...
        <FadeIn delay={150}>
          <p className="text-lg text-vercel-gray-400 max-w-[540px] mb-12" style={{ lineHeight: 1.7 }}>
            Open to opportunities in data engineering, cloud infrastructure, and AI/ML.
            Currently based in Bloomington-Normal, IL.
          </p>
        </FadeIn>

        <FadeIn delay={200}>
          <div className="flex flex-col sm:flex-row gap-4 mb-20 flex-wrap">
            <a
              href="mailto:desmondfungjob@gmail.com"
